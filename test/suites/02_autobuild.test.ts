...
suite('Auto-build test suite', () => {
    ...
    test.only(suiteName, fixtureName, 'auto build with input whose path uses a macro', async () => {
        await test.loadAndCache(fixture, [
    ...
    test.only(suiteName, fixtureName, 'auto build with watch.files.ignore', async () => {
